...
print(f'String ASCII letters : {string.ascii_letters}')

# String ASCII lowercase letters
print(f'String ASCII lowercase letters : {string.ascii_lowercase}')

# String ASCII uppercase letters
print(f'String ASCII uppercase letters : {string.ascii_uppercase}')

# String digit characters
