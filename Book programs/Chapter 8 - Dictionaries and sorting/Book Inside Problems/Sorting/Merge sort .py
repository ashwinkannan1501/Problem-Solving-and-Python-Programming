# Merge sort
"""Merge sort is based on 'divide and conquer' technique. The 'divide and conquer' technique is the
fastest technique algorithm"""
...
print(f'The sorted list is : {merge_sort([5, 1, 100, 65, 56, 93, 12, 0, 200, 125])}')
